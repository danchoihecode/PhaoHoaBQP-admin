  ...
  <div class="flex justify-between">
    <div class="flex flex-col w-[70%] ">
            ...
            <div class="w-[100%]">
              <div class="relative">
                ...
                <label for="youtube_url"
                  class="absolute left-[16px] top-[20px] text-[16px] text-[#7E8299]  bg-[#EDF2F7] transition-all duration-200 transform peer-focus:-translate-y-[18px] peer-focus:text-[13px]">
                  Youtube Video ID (e.g. MtDOvqvuTx0)
                </label>
              </div>
            </div>
          </div>
      ...
      <div class="flex items-center justify-center mt-4">
        <BaseButton :title="'LƯU'" :customStyle="'custom-btn-style'" @onClick="createProduct" />
      </div>
    </div>
    <div class="w-[28%]">
      <Content>
...
const infoList = ref([{ description: '', key: '' }]);
...
const listBreadcrumb = [
  ...
  { label: 'Thêm sản phẩm', path: '/product/add-product' },
];
...
const addInfo = () => {
  ...
  if (lastInfo.description && lastInfo.key) {
    infoList.value.push({ description: '', key: ''});
  }
};
